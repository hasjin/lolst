        ...
        <main className="container">
            <header className="hero" style={{display:'grid', gap:12}}>
                <div style={{display:'flex', justifyContent:'space-between', alignItems:'center'}}>
                    <div className="chip"><Trans ko="개인정보 처리방침" en="Privacy Policy" /></div>
                    <LanguageSwitcher />
                </div>
                <h1>{SITE_NAME}</h1>
                <p className="subtitle">
                    <Trans
                        ko={<>본 방침은 다음 도메인에 적용됩니다: {DOMAINS.join(', ')}</>}
                        en={<>This policy applies to: {DOMAINS.join(', ')}</>}
                    />
                </p>
            ...
            <div className="page">
                <aside className="toc">
                    ...
                    <nav>
                        <a href="#collect"><Trans en='1. Data We Do Not Collect' ko='1. 수집하지 않는 정보'/></a>
                        <a href="#items"><Trans en='2. Data We May Process' ko='2. 처리하는 정보(필요 시)'/></a>
                        <a href="#purpose"><Trans en='3. Purposes' ko='3. 이용 목적'/></a>
                        <a href="#retention"><Trans en='4. Retention' ko='4. 보유 기간'/></a>
                        <a href="#sharing"><Trans en='5. Sharing' ko='5. 제3자 제공'/></a>
                        <a href="#overseas"><Trans en='6. Processing Abroad' ko='6. 국외 처리'/></a>
                        <a href="#cookies"><Trans en='7. Cookies' ko='7. 쿠키 및 추적'/></a>
                        <a href="#rights"><Trans en='8. Your Rights' ko='8. 이용자 권리'/></a>
                        <a href="#security"><Trans en='9. Security' ko='9. 안전조치'/></a>
                        <a href="#children"><Trans en='10. Children' ko='10. 아동의 개인정보'/></a>
                        <a href="#notice"><Trans en='11. Notice & Changes' ko='11. 고지 및 개정'/></a>
                        <a href="#contact"><Trans en='12. Contact' ko='12. 문의처'/></a>
                        <a href="#riot"><Trans en='Appendix: Riot Notice' ko='붙임: Riot 고지'/></a>
                    </nav>
                </aside>
                ...
                <article className="prose">
                    <Trans en={
                        <>
                            <section id="collect"><h2>1. Data We Do Not Collect</h2>
                                <p>No accounts or community features. We do not collect personal identifiers beyond what is necessary to operate the Service.</p>
                            </section>
                            <section id="items"><h2>2. Data We May Process</h2>
                                <ul>
                                    <li><b>Inquiry email</b>: If you email us voluntarily, we will process your address and message.</li>
                                    <li><b>Technical logs</b>: IP, timestamps, user agent, error logs for security/operations.</li>
                                </ul>
                            </section>
                            <section id="purpose"><h2>3. Purposes</h2>
                                <ul><li>Operate the Service, fix errors, improve quality</li><li>Security and abuse detection</li><li>Respond to inquiries</li></ul>
                            </section>
                            <section id="retention"><h2>4. Retention</h2>
                                <ul><li>Inquiry emails: up to 3 years after resolution</li><li>Technical logs: up to 6–12 months</li><li>Or as required by law</li></ul>
                            </section>
                            ...
                            <section id="security"><h2>9. Security</h2>
                                <ul><li>Minimal collection and access control</li><li>HTTPS in transit</li><li>Log monitoring</li><li>Regular updates</li></ul>
                            </section>
                           ...
                           ko = {
                        <>
                            {/* 한국어 버전 (이전에 준 본문과 동일 요약) */}
                            <section id="collect"><h2>1. 수집하지 않는 정보</h2><p>회원가입·커뮤니티 기능이 없으며, 필요하지 않은 개인정보는 수집하지 않습니다.</p></section>
                            <section id="items"><h2>2. 처리하는 정보(필요 시)</h2>
                                <ul><li><b>문의 이메일</b>: 자발적 문의 시 이메일·내용</li><li><b>기술 로그</b>: IP, 시간, UA, 오류 로그 등</li></ul>
                            </section>
                            ...
                            <section id="security"><h2>9. 안전조치</h2>
                                <ul><li>최소 수집·접근권한 통제</li><li>HTTPS</li><li>로그 모니터링</li><li>정기 업데이트</li></ul>
                            </section>
